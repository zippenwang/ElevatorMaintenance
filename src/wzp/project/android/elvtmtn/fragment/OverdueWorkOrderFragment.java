...
public class OverdueWorkOrderFragment extends Fragment {
	...
	private PullToRefreshListView ptrlvOverdue;
	...
	private void initData() {
		dataList.addAll(Arrays.asList("A", "B", "C", "D", "E"));
	...
	private void initWidget(View view) {
		...
		ptrlvOverdue.setAdapter(adapter);
//		ptrlvOverdue.getLoadingLayoutProxy().setLastUpdatedLabel("你好");
		
		// 设置下拉刷新的具体操作
		ptrlvOverdue.setOnRefreshListener(new OnRefreshListener<ListView>() {
			@Override
			public void onRefresh(PullToRefreshBase<ListView> refreshView) {
				/*
				 * 更新下拉列表时的提示信息 
				 */
//				String label = "上次刷新时间：" + DateUtils.formatDateTime(MyApplication.getContext(), System.currentTimeMillis(),  
